        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="w-10 h-10 bg-gradient-button rounded-lg flex items-center justify-center hover:scale-110 transition-transform"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-pink-600 rounded-lg flex items-center justify-center hover:scale-110 transition-transform"
              >
              ...
              <a
                href="https://linkedin.com/in/pawanwashudev"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              >
                <WhatsAppIcon />
                <span>WhatsApp @pawanwashudev</span>
              </a>
              <a 
                href="https://t.me/pawanwashudev"
                target="_blank"
              ...
              >
                ...
                <span>Telegram @pawanwashudev</span>
              </a>
              <a
                href="https://instagram.com/pawanwashudev"
                target="_blank"
              ...
              >
                ...
                <span>LinkedIn @pawanwashudev</span>
              </a>
            </div>
          </div>
        </div>
