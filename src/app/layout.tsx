...
export const metadata: Metadata = {
  ...
  description: "Neubofy is the technology department for founders and businesses. We orchestrate independent technology specialists, coordinate delivery, and help businesses build the right technology without building an internal technology department.",
  keywords: [
    "technology department for startups",
    "technology department for small businesses",
  ...
  openGraph: {
    ...
    description: "Neubofy translates business problems into technology requirements, orchestrates independent specialists, and verifies the result before delivery.",
    siteName: "Neubofy",
  },
  twitter: {
