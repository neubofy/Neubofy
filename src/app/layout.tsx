...
export const metadata: Metadata = {
  ...
  description: "Neubofy is a technology company and consultancy that acts as an external technology department for businesses. We translate business problems into technology requirements, orchestrate independent specialists, and verify the result before delivery.",
  keywords: [
    "technology consulting",
    "technology department",
    "software/AI/integration/security",
